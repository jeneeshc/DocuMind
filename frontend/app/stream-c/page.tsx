            ...
            <div className="flex-none">
                <h2 className="text-3xl font-bold tracking-tight text-gray-900 flex items-center">
                    <div className="p-2 bg-orange-100 rounded-lg mr-3">
                        <BrainCircuit className="w-6 h-6 text-orange-700" />
                    </div>
            ...
            <div className="grid gap-8 md:grid-cols-3 flex-1 overflow-hidden min-h-[500px]">
                ...
                <div className="md:col-span-2 flex flex-col h-full">
                    <Card className="flex flex-col h-full border-none shadow-none bg-transparent">
                        <CardContent className="flex-1 overflow-y-auto p-4 space-y-4 bg-white rounded-t-xl border border-b-0 min-h-[400px]">
                            {messages.length === 0 ? (
                        ...
                        <div className="p-4 bg-white border border-t-0 rounded-b-xl flex items-center gap-2">
                            <input
                                className="flex-1 p-3 bg-gray-50 border rounded-full focus:outline-none focus:ring-2 focus:ring-orange-500 text-sm"
                            ...
                            <button
                                ...
                                className="p-3 bg-orange-600 hover:bg-orange-700 text-white rounded-full transition disabled:opacity-50"
                            >
